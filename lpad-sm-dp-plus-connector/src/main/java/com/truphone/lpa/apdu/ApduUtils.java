...
public class ApduUtils {
    ...
    public static List<String> authenticateServerApdu(String smdpSigned1, String smdpSignature1, String euiccCiPKIdToBeUsed,
        ...
        String sctxParams1 = ToTLV.toTLV("A0", ToTLV.toTLV("80", matchingId) + ToTLV.toTLV("A1",
            ToTLV.toTLV("80", "3A756706") + ToTLV.toTLV("A1", ToTLV.toTLV("80","070000"))
          + ToTLV.toTLV("82","3A75670689323005")
